...
import { FuxaViewDialogComponent, FuxaViewDialogData } from './dreamz-scada-view-dialog/dreamz-scada-view-dialog.component';
...
@Component({
    selector: 'app-dreamz-scada-view',
    templateUrl: './dreamz-scada-view.component.html',
    styleUrls: ['./dreamz-scada-view.component.css']
})
export class FuxaViewComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        private dreamzScadaDialog: MatDialog) {
    }
    ...
    openDialog(event, viewref: string, options: any = {}) {
        ...
        let dialogRef = this.dreamzScadaDialog.open(FuxaViewDialogComponent, {
            panelClass: 'dreamz-scada-dialog-property',
            disableClose: true,
            data: dialogData,
            autoFocus: false,
            position: { top: '60px' }
    ...
    onMonitor(gaugeSettings: GaugeSettings, event: any, viewref: string, options: any = {}) {
        ...
        let dialogRef = this.dreamzScadaDialog.open(WebcamPlayerDialogComponent, {
            panelClass: 'dreamz-scada-dialog-property',
            disableClose: false,
            data: dialogData,
            position: pos
