export const THEMES = {
    default: {
        ...
        sidenavBackground: '#0F172A',
        toolboxItemActiveBackground: '#1E40AF',
    ...
    dark: {
        ...
        sidenavBackground: '#0F172A',
        toolboxItemActiveBackground: '#0EA5E9',
        toolboxItemActiveColor: '#FFFFFF',
